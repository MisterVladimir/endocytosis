...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "C:\\Users\\v\\Anaconda3\\envs\\tensorflow\\lib\\site-packages\\numpy\\core\\include"
        ],
        "name": "endocytosis.simulation.obj.cygauss2d",
        "sources": [
            "endocytosis\\simulation\\obj\\cygauss2d.pyx"
        ]
    },
    "module_name": "endocytosis.simulation.obj.cygauss2d"
}
END: Cython Metadata */
...
#define __PYX_HAVE__endocytosis__simulation__obj__cygauss2d
#define __PYX_HAVE_API__endocytosis__simulation__obj__cygauss2d
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'endocytosis.simulation.obj.cygauss2d' */
...
#define __Pyx_MODULE_NAME "endocytosis.simulation.obj.cygauss2d"
extern int __pyx_module_is_main_endocytosis__simulation__obj__cygauss2d;
int __pyx_module_is_main_endocytosis__simulation__obj__cygauss2d = 0;

/* Implementation of 'endocytosis.simulation.obj.cygauss2d' */
...
/* "endocytosis/simulation/obj/cygauss2d.pyx":26
 * 
 * 
...
static double __pyx_f_11endocytosis_10simulation_3obj_9cygauss2d_objective(double __pyx_v_A, double __pyx_v_sigma, double __pyx_v_x, double __pyx_v_y, CYTHON_UNUSED double __pyx_v_mx, CYTHON_UNUSED double __pyx_v_my, CYTHON_UNUSED double __pyx_v_b, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_X, __Pyx_memviewslice __pyx_v_Y) {
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":31
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":32
 * 
 *     cdef Py_ssize_t imax = data.shape[0]
 *     cdef Py_ssize_t jmax = data.shape[1]             # <<<<<<<<<<<<<<
 *     cdef double ret = 0.0
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":33
 *     cdef Py_ssize_t imax = data.shape[0]
 *     cdef Py_ssize_t jmax = data.shape[1]
 *     cdef double ret = 0.0             # <<<<<<<<<<<<<<
 *     sigma = 2*sigma**2
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":34
 *     cdef Py_ssize_t jmax = data.shape[1]
 *     cdef double ret = 0.0
 *     sigma = 2*sigma**2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":36
 *     sigma = 2*sigma**2
 * 
 *     for i in range(imax):             # <<<<<<<<<<<<<<
 *         for j in range(jmax):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "endocytosis/simulation/obj/cygauss2d.pyx":37
 * 
 *     for i in range(imax):
 *         for j in range(jmax):             # <<<<<<<<<<<<<<
 *             ret += (data[i, j] - A*np.exp(
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "endocytosis/simulation/obj/cygauss2d.pyx":38
 *     for i in range(imax):
 *         for j in range(jmax):
 *             ret += (data[i, j] - A*np.exp(             # <<<<<<<<<<<<<<
 *                 -((X[i, j] - x)**2 + (Y[i, j] - y)**2)/sigma))**2
 ...
 */
      ...
      /* "endocytosis/simulation/obj/cygauss2d.pyx":39
 *         for j in range(jmax):
 *             ret += (data[i, j] - A*np.exp(
 *                 -((X[i, j] - x)**2 + (Y[i, j] - y)**2)/sigma))**2             # <<<<<<<<<<<<<<
 *     return ret
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":40
 *             ret += (data[i, j] - A*np.exp(
 *                 -((X[i, j] - x)**2 + (Y[i, j] - y)**2)/sigma))**2
 *     return ret             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("endocytosis.simulation.obj.cygauss2d.objective", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "endocytosis/simulation/obj/cygauss2d.pyx":43
 * 
 * # why did I originally use 'def' instead of 'cdef'?
...
static PyObject *__pyx_f_11endocytosis_10simulation_3obj_9cygauss2d_model(double __pyx_v_A, double __pyx_v_sigma, double __pyx_v_x, double __pyx_v_y, CYTHON_UNUSED double __pyx_v_mx, CYTHON_UNUSED double __pyx_v_my, CYTHON_UNUSED double __pyx_v_b, __Pyx_memviewslice __pyx_v_X, __Pyx_memviewslice __pyx_v_Y) {
  Py_ssize_t __pyx_v_imax;
  Py_ssize_t __pyx_v_jmax;
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":46
 *            double mx, double my, double b, int [:,::1] X, int [:,::1] Y):
 * 
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":47
 * 
 *     cdef Py_ssize_t imax = X.shape[0]
 *     cdef Py_ssize_t jmax = X.shape[1]             # <<<<<<<<<<<<<<
 *     sigma = 2*sigma**2
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":48
 *     cdef Py_ssize_t imax = X.shape[0]
 *     cdef Py_ssize_t jmax = X.shape[1]
 *     sigma = 2*sigma**2             # <<<<<<<<<<<<<<
 *     ret_py = np.zeros_like(X, dtype=np.double)
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":49
 *     cdef Py_ssize_t jmax = X.shape[1]
 *     sigma = 2*sigma**2
 *     ret_py = np.zeros_like(X, dtype=np.double)             # <<<<<<<<<<<<<<
 *     cdef double [:,::1] ret_c = ret_py
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_X, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":50
 *     sigma = 2*sigma**2
 *     ret_py = np.zeros_like(X, dtype=np.double)
 *     cdef double [:,::1] ret_c = ret_py             # <<<<<<<<<<<<<<
 * 
 *     for i in range(imax):
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_v_ret_py, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 50, __pyx_L1_error)
  __pyx_v_ret_c = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "endocytosis/simulation/obj/cygauss2d.pyx":52
 *     cdef double [:,::1] ret_c = ret_py
 * 
 *     for i in range(imax):             # <<<<<<<<<<<<<<
 *         for j in range(jmax):
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "endocytosis/simulation/obj/cygauss2d.pyx":53
 * 
 *     for i in range(imax):
 *         for j in range(jmax):             # <<<<<<<<<<<<<<
 *         # used to be ret_c [:,::1] = ... ?? not sure why
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "endocytosis/simulation/obj/cygauss2d.pyx":55
 *         for j in range(jmax):
 *         # used to be ret_c [:,::1] = ... ?? not sure why
 *             ret_c [i, j::1] = A*np.exp(             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_5 = PyFloat_FromDouble(__pyx_v_A); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 55, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 55, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_exp); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 55, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

      /* "endocytosis/simulation/obj/cygauss2d.pyx":56
 *         # used to be ret_c [:,::1] = ... ?? not sure why
 *             ret_c [i, j::1] = A*np.exp(
 *                 -((X[i, j] - x)**2 + (Y[i, j] - y)**2)/sigma)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_3 = PyFloat_FromDouble((__pyx_t_18 / __pyx_v_sigma)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 56, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = NULL;
      ...
      if (!__pyx_t_4) {
        ...
        #endif
        {
          __pyx_t_19 = PyTuple_New(1+1); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 55, __pyx_L1_error)
          ...
          __pyx_t_3 = 0;
          __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_19, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 55, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
 ...
 */
      ...
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...

{
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":58
 *                 -((X[i, j] - x)**2 + (Y[i, j] - y)**2)/sigma)
 * 
 *     return ret_py             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_20, 1);
  __Pyx_AddTraceback("endocytosis.simulation.obj.cygauss2d.model", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "endocytosis.simulation.obj.cygauss2d.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "endocytosis.simulation.obj.cygauss2d.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "endocytosis.simulation.obj.cygauss2d.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "endocytosis.simulation.obj.cygauss2d._memoryviewslice", /*tp_name*/
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_endocytosis__simulation__obj__cygauss2d) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "endocytosis.simulation.obj.cygauss2d")) {
      if (unlikely(PyDict_SetItemString(modules, "endocytosis.simulation.obj.cygauss2d", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":22
 * """
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport cython
 ...
 */
  ...
  /* "endocytosis/simulation/obj/cygauss2d.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * """
 * @author: Vladimir Shteyn
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init endocytosis.simulation.obj.cygauss2d", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init endocytosis.simulation.obj.cygauss2d");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
